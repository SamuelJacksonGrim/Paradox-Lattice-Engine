# Contributing to Paradox-Lattice-Engine

Thanks for your interest in improving Paradox-Lattice-Engine. This document covers how to
contribute and — importantly — the licensing terms your contribution is made under.
Please read the **Contributor License Agreement** below before opening a pull request.

## How to contribute

- Open an issue first for anything non-trivial, so we can agree on the approach.
- Keep pull requests focused; one logical change per PR.
- Run the project's test suite before submitting (see the README for how).
- Match the surrounding code style and comment density.

## License

Paradox-Lattice-Engine is licensed under the **GNU Affero General Public License v3.0**
